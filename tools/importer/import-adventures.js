...
const PAGE_TEMPLATE = {
  name: 'adventures',
  description: 'WKND adventure detail page: hero carousel, adventure specifications, and tabbed detail content.',
  urls: [
  ...
  blocks: [
    {
      name: 'carousel-hero',
      instances: ['.carousel.cmp-carousel--mini', '.carousel.cmp-carousel--hero'],
    },
    {
      name: 'columns-specs',
      instances: ['.cmp-contentfragment__elements'],
    },
    {
      name: 'tabs-detail',
  ...
  sections: [
    {
      id: 's1', name: 'hero', selector: ['.carousel.cmp-carousel--mini', '.carousel.cmp-carousel--hero'], style: null, blocks: ['carousel-hero'], defaultContent: [],
    },
    {
      id: 's2', name: 'body', selector: ['main.cmp-layout-container--fixed'], style: null, blocks: ['columns-specs', 'tabs-detail'], defaultContent: ['.title.cmp-title--underline', 'h1'],
    },
  ],
};
